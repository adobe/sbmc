...
project = 'Sample-Based Monte Carlo Denoising using a Kernel-Splatting Network'
copyright = '2019, Michael Gharbi'
author = 'Michael Gharbi'

# The full version, including alpha/beta/rc tags
import re
with open(os.path.join(rootdir, "sbmc/version.py")) as fid:
    try:
